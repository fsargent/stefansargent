<!DOCTYPE html>
	...
	<title>Log In &lsaquo; Stefan Sargent &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In"/>
									<input type="hidden" name="redirect_to" value="http://3.22.77.140/wp-admin/"/>
...
wp_attempt_focus();if(typeof wpOnload==='function'){wpOnload()}</script>
		...
		&larr; Back to Stefan Sargent		</a></p>
			</div>
	<script type='text/javascript' src='/wp-includes/js/jquery/jquery.js?ver=1.12.4-wp'></script>
<script type='text/javascript' src='/wp-includes/js/jquery/jquery-migrate.min.js?ver=1.4.1'></script>
<script type='text/javascript'>//<![CDATA[
var _zxcvbnSettings={"src":"https:\/\/3.22.77.140\/wp-includes\/js\/zxcvbn.min.js"};
//]]></script>
